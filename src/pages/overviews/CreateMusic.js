...
const CreateMusic = () => {
  ...
  return (
    <>
      {contextHolder}
      <button onClick={() => setShowAddModal(true)} style={{ margin: "3px" }}>
        {" "}
        + Thêm mới bài hát
      </button>
      {showAddModal && (
        <div className="modal-overlay">
          <div className="modal-content">
            ...
            <input
              ...
              onChange={(e) =>
                setNewSongData({ ...newSongData, avatar: e.target.value })
              }
            />
            ...
            <select
              ...
              onChange={(e) =>
                setNewSongData({ ...newSongData, singerId: e.target.value })
              }
            >
            ...
            <select
              ...
              onChange={(e) =>
                setNewSongData({ ...newSongData, topicId: e.target.value })
              }
            >
            ...
            <input
              ...
              onChange={(e) =>
                setNewSongData({ ...newSongData, like: Number(e.target.value) })
              }
            />
