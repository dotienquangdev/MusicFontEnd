        ...
        <Routes>
          ...
          <Route path="/" element={<LayoutTong />}>
            <Route
              ...
              element={
                <MainpageInde
                  title={`${system?.siteName || "Zing"}-Khám phá`}
                />
              }
            ></Route>
            <Route
              path="/song"
              element={<Song title={`${system?.siteName || "Zing"}-Bài hát`} />}
            ></Route>
            ...
            <Route
              path="/song/:id"
              element={
                <SongDetail title={`${system?.siteName || "Zing"}-Bài hát`} />
              }
            ></Route>
            <Route
              path="/topic/:id"
              element={
                <AbumDatail title={`${system?.siteName || "Zing"}-Abum`} />
              }
            ></Route>
            <Route
              path="/singer/:id"
              element={
                <SingerDetail title={`${system?.siteName || "Zing"} - Ca sỹ`} />
              }
            ></Route>
            ...
            <Route
              path="/library"
              element={
                <Ibeary title={`${system?.siteName || "Zing"}-Thư Viện`} />
              }
            ></Route>
            <Route
              path="/zingchart"
              element={
                <SingerDetail
                  title={`${system?.siteName || "Zing"}-Zing chát`}
                />
              }
            ></Route>
            <Route
              path="/overview"
              element={
                <Overview title={`${system?.siteName || "Zing"}-Tổng Quan`} />
              }
            ></Route>
            <Route
              path="/setting"
            ...
            <Route
              ...
              element={
                <SingerDetail
                  title={`${system?.siteName || "Zing"}-Nhạc Mới`}
                />
              }
            ></Route>
            <Route
              ...
              element={
                <SingerDetail
                  title={`${system?.siteName || "Zing"}-Chủ đề-Thể loại`}
                />
              }
            ></Route>
            <Route
              path="/top100"
              element={
                <SingerDetail title={`${system?.siteName || "Zing"}-Top 100`} />
              }
            ></Route>
          </Route>
        </Routes>
